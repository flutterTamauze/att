...
const localURL = "http://192.168.0.111:8010";
...
DateTime kAndroidReleaseDate = DateTime(DateTime.now().year, 11, 30);
DateTime _currentBackPressTime;
DateTime kiosReleaseDate = DateTime(DateTime.now().year, 11, 30);
//ERRORS
