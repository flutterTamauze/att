                                    ...
                                    Column(
                                      children: [
                                        ...
                                        AdvancedShiftPicker(
                                          ...
                                          timeInController: sunTimeInController,
                                          timeOutController:
                                              sunTimeOutController,
                                          toPickedWeek: sunToT,
                                          callBackfunFrom: (TimeOfDay v) {
                                        ...
                                        AdvancedShiftPicker(
                                          weekDay:
                                              getTranslated(context, "الأثنين"),
                                          isShiftsScreen: true,
                                          fromPickedWeek: monFromT,
                                          timeInController: monTimeInController,
                                          timeOutController:
                                              monTimeOutController,
                                          toPickedWeek: monToT,
                                          callBackfunFrom: (TimeOfDay v) {
                                        ...
                                        AdvancedShiftPicker(
                                          ...
                                          timeInController: wedTimeInController,
                                          timeOutController:
                                              wedTimeOutController,
                                          toPickedWeek: wedToT,
                                          callBackfunFrom: (TimeOfDay v) {
                                        ...
                                        AdvancedShiftPicker(
                                          weekDay:
                                              getTranslated(context, "الخميس"),
                                          isShiftsScreen: true,
                                          fromPickedWeek: thuFromT,
                                          timeInController: thuTimeInController,
                                          timeOutController:
                                              thuTimeOutController,
                                          toPickedWeek: thuToT,
                                          callBackfunFrom: (TimeOfDay v) {
                                        ...
                                        AdvancedShiftPicker(
                                          weekDay:
                                              getTranslated(context, "الجمعة"),
                                          isShiftsScreen: true,
                                          fromPickedWeek: friFromT,
                                          timeInController: friTimeInController,
                                          timeOutController:
                                              friTimeOutController,
                                          toPickedWeek: friToT,
                                          callBackfunFrom: (TimeOfDay v) {
                          ...
                          Padding(
                            ...
                            child: RoundedButton(
                              onPressed: () async {
                                ...
                                sunFrom = DateTime(now.year, now.month, now.day,
                                    sunT.hour, sunT.minute);
                                monFrom = DateTime(now.year, now.month, now.day,
                                    monT.hour, monT.minute);
                                tuesFrom = DateTime(now.year, now.month,
                                    now.day, tuesT.hour, tuesT.minute);
                                wedFrom = DateTime(now.year, now.month, now.day,
                                    wedT.hour, wedT.minute);
                                friFrom = DateTime(now.year, now.month, now.day,
                                    friT.hour, friT.minute);
                                thuFrom = DateTime(now.year, now.month, now.day,
                                    thurT.hour, thurT.minute);
                                friFrom = DateTime(now.year, now.month, now.day,
                                    friT.hour, friT.minute);
                                ...
                                tuesTo = DateTime(now.year, now.month, now.day,
                                    tuesTT.hour, tuesTT.minute);
                                ...
                                endString = DateFormat("HH:mm").format(dateTo);

                                _sunFrom = DateFormat("HH:mm").format(sunFrom);
                                _sunTo = DateFormat("HH:mm").format(sunTo);
                                _monFrom = DateFormat("HH:mm").format(monFrom);
                                _monTo = DateFormat("HH:mm").format(monTo);
                                _thuFrom = DateFormat("HH:mm").format(thuFrom);
                                _thuTo = DateFormat("HH:mm").format(thuTo);
                                _wedFrom = DateFormat("HH:mm").format(wedFrom);
                                _wedTo = DateFormat("HH:mm").format(wedTo);
                                _friFrom = DateFormat("HH:mm").format(friFrom);
